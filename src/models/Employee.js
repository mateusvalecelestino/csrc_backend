...
export default class Employee extends Model {
  ...
  static associate(models) {
    ...
    this.hasOne(models.EmployeeContact, {
      as: 'contacts',
    ...
    super.init(
      {
        ...
        full_name: {
          ...
          validate: {
            notEmpty: {
              msg: 'Nome de funcionário não deve estar vazio.',
            },
            len: {
              args: [10, 100],
        ...
        birth_date: {
          ...
          validate: {
            isDate: {
              msg: 'Data de nascimento de funcionário inválida.',
            },
          },
        },
        gender: {
        ...
        order_number: {
          ...
          validate: {
            notEmpty: {
              msg: 'Número de ordem de funcionário não pode ser vazio.',
            },
            len: {
              args: [3, 30],
        ...
        tel: {
          ...
          validate: {
            notEmpty: {
              msg: 'Telefone de funcionário não deve estar vazio.',
            },
            len: {
              args: [11, 20],
        ...
        role_id: {
          ...
          defaultValue: '',
          validate: {
            isInt: { msg: 'Cargo de funcionário inválido.' },
          },
        },
        specialty_id: {
          type: DataTypes.INTEGER,
          ...
          validate: {
            isInt: {
              msg: 'Especialidade de funcionário inválido.',
            },
          },
        },
        user_id: {
        ...
        created_by: {
          ...
          defaultValue: '',
          validate: {
            isInt: { msg: 'Criador de funcionário inválido.' },
          },
        },
        updated_by: {
          type: DataTypes.INTEGER,
          defaultValue: '',
          validate: {
            isInt: { msg: 'Actualizador de funcionário inválido.' },
          },
        },
      },
      {
        ...
        hooks: {
          ...
          async beforeCreate(employee, options) {
            ...
            try {
              ...
              const user = await this.sequelize.models.User.create(userData, {
                transaction: t,
              });
          ...
          async afterSave(employee, options) {
            ...
            try {
              ...
              await this.sequelize.models.EmployeeContact.create(
                employeeContact,
                { transaction: t }
              );
            } catch (e) {
