        ...
        super.init(
            {
                ...
                name: {
                    ...
                    validate: {
                        notEmpty: {
                            msg: 'Nome de especialidade não deve estar vazio.',
                        },
                        len: {
                            args: [3, 50],
                ...
                created_by: {
                    ...
                    defaultValue: '',
                    validate: {
                        isInt: { msg: 'Criador de especialidade inválido.' },
                    },
                },
                updated_by: {
                    type: DataTypes.INTEGER,
                    ...
                    validate: {
                        isInt: {
                            msg: 'Actualizador de especialidade inválido.',
                        },
                    },
                },
            },
