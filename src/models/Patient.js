...
export default class Patient extends Model {
  ...
  static associate(models) {
    ...
    this.hasOne(models.PatientAddress, {
      as: 'address',
    ...
    super.init(
      {
        ...
        full_name: {
          ...
          validate: {
            notEmpty: {
              msg: 'Nome de paciente não deve estar vazio.',
            },
            len: {
              args: [10, 100],
        ...
        fathers_name: {
          ...
          validate: {
            notEmpty: {
              msg: 'Nome do pai do paciente não deve estar vazio.',
            },
            len: {
              args: [10, 100],
        ...
        mothers_name: {
          ...
          validate: {
            notEmpty: {
              msg: 'Nome da mãe do paciente não deve estar vazio.',
            },
            len: {
              args: [10, 100],
        ...
        birth_date: {
          ...
          validate: {
            isDate: {
              msg: 'Data de nascimento do paciente inválida.',
            },
          },
        },
        street: {
        ...
        hooks: {
          async afterSave(patient, options) {
            ...
            try {
              ...
              await this.sequelize.models.PatientAddress.create(addressData, {
                transaction: t,
              });
            } catch (e) {
              throw e;
